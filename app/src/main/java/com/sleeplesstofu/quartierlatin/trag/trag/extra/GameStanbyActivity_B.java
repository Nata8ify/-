...
import com.sleeplesstofu.quartierlatin.trag.Play_B_NoneStopMode;
import com.sleeplesstofu.quartierlatin.trag.R;

public class GameStanbyActivity_B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_stanby_activity__b);
        startUpWidget();
